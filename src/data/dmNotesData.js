...
export const dmNotesSections = [
  {
    ...
    content: (
      <>
        ...
        <p>
          Guild "Penjaga Fragmentasi" menerima panggilan darurat dari Arimantya
          Cahyamaguna (Scholar, Lembara), seorang cendekiawan terkemuka dan
          teman lama Alaric. Arimantya melaporkan adanya "wabah pikiran" yang
          menyebar, membuat penduduk menjadi agresif dan paranoid.
        </p>
        <strong>Misi:</strong>
        <p>
          Guild dikirim untuk menyelidiki. Alaric memimpin. Wabah ternyata
          adalah manipulasi pikiran massal, dipicu oleh frekuensi sihir gelap
          yang berasal dari reruntuhan kuno di bawah Lembara.
        </p>
        <strong>Manifestasi Malapetaka:</strong>
        <p>
          "Kabut Pikiran" – sebuah energi eterik yang memanipulasi emosi negatif
          (kemarahan, ketakutan, paranoia) pada individu yang lemah mental.
        </p>
        <strong>Petunjuk:</strong>
        <p>
          Simbol-simbol kuno yang rusak dan coretan yang aneh muncul di dinding
          reruntuhan. Penduduk yang terkena wabah sering mengucapkan frasa yang
          sama secara berulang-ulang, yang jika disatukan, membentuk mantra yang
          tidak lengkap.
        </p>
        <strong>Penemuan:</strong>
        <p>
          Para PC menemukan sumber daya sihir tersembunyi yang terkontaminasi di
          bawah reruntuhan, memancarkan energi Malapetaka. Guild berhasil
          meredamnya sementara, tetapi menyadari ini hanyalah permukaan. Alaric
          menemukan peta yang menunjukkan potensi sumber-sumber sihir lain di
          seluruh Astreya.
        </p>
        <strong>Legenda:</strong>
        <ul>
          <li>Akademi Veritas (Veritas Academy): Pusat ilmu pengetahuan.</li>
          <li>
            Pusat Arcane (The Arcane Hub): Bangunan kubah raksasa di tengah
            kota.
          </li>
          <li>
            Reruntuhan Bawah Tanah (The Undercity Ruins): Jaringan terowongan
            kuno.
          </li>
          <li>Area Ladang (The Farmlands): Ladang yang mengelilingi kota.</li>
          <li>
            Jembatan Sinar (The Sunbeam Bridge): Jembatan utama menuju kota.
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <strong>Pemicu Misi:</strong>
        <p>
          Setelah meredam ancaman di Lembara, Guild menerima berita dari Jaya
          Volkov, yang melaporkan bahwa Malapetaka telah merusak lanskap beku
          Gelvara. Musim dingin menjadi lebih mematikan, makhluk es menjadi
          agresif, dan tanaman es mulai membusuk.
        </p>
        <strong>Misi:</strong>
        <p>
          Guild melakukan perjalanan ke Gelvara, Jaya memimpin. Mereka menemukan
          bahwa energi Malapetaka di sana memanipulasi elemen es, membuatnya
          menjadi agen kehancuran.
        </p>
        <strong>Manifestasi Malapetaka:</strong>
        <p>
          "Es Pembusuk" – sihir gelap yang merusak struktur es dan kehidupan di
          dalamnya, mengubahnya menjadi agen kehancuran yang dingin.
        </p>
        <strong>Petunjuk:</strong>
        <p>
          Hewan yang terinfeksi menunjukkan pola kebusukan es yang aneh. Suara
          rintihan berasal dari gua-gua tempat kristal es raksasa bergetar dengan
          energi gelap.
        </p>
        <strong>Penemuan:</strong>
        <p>
          Di jantung gua es, para PC menemukan kristal sihir kuno yang pecah,
          memancarkan energi Malapetaka. Jaya mencatat simbol yang sama seperti
          yang ditemukan Alaric di Lembara.
        </p>
        <strong>Legenda:</strong>
        <ul>
          <li>Benteng Es (The Ice Fortress): Permukiman utama suku Frostborn.</li>
          <li>
            Gletser Retak (The Cracked Glacier): Gletser purba dengan retakan
            besar.
          </li>
          <li>
            Lembah Reruntuhan (The Ruin Valley): Reruntuhan kuno terkubur salju.
          </li>
          <li>Hutan Beku (The Frozen Woods): Hutan dengan makhluk es agresif.</li>
          <li>
            Sungai Pembeku (The Freezing River): Sungai yang membeku cepat.
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <strong>Pemicu Misi:</strong>
        <p>
          Elaria Cahyarimbun merasakan alam Drenmar dalam bahaya besar.
          Pepohonan besar mulai sakit, daun gugur, dan suara bisikan aneh
          terdengar dari dalam hutan.
        </p>
        <strong>Misi:</strong>
        <p>
          Guild pergi ke Drenmar, Elaria memimpin. Mereka menemukan bahwa
          Malapetaka di sini membusukkan kehidupan itu sendiri.
        </p>
        <strong>Manifestasi Malapetaka:</strong>
        <p>
          "Penyakit Akar" – sihir gelap yang menyusup ke dalam jaringan kehidupan
          hutan, membusukkan pohon dan tanaman dari dalam.
        </p>
        <strong>Petunjuk:</strong>
        <p>
          Akar-akar pohon memancarkan cahaya ungu samar dan mengeluarkan cairan
          kental. Bisikan-bisikan itu adalah suara pikiran yang terdistorsi dari
          Dryad dan Spirit Hutan yang terinfeksi.
        </p>
        <strong>Penemuan:</strong>
        <p>
          Di jantung hutan, di bawah pohon suci yang hampir mati, mereka
          menemukan sebuah altar kuno yang pecah. Altar ini dulunya menyalurkan
          sihir ke hutan, namun kini telah terkontaminasi. Ada ukiran simbol
          yang sama lagi, menunjukkan upaya sistematis untuk merusak aliran
          sihir di setiap wilayah.
        </p>
        <strong>Legenda:</strong>
        <ul>
          <li>
            Perlindungan Lirien (Lirien's Sanctuary): Permukiman utama para elf.
          </li>
          <li>Pohon Hati (The Heartwood Tree): Pohon suci tertua.</li>
          <li>Sungai Kehidupan (The River of Life): Sungai utama Drenmar.</li>
          <li>
            Reruntuhan Bawah Pohon (Ruins Below the Trees): Reruntuhan kuno.
          </li>
          <li>Danau Cahaya (The Lake of Light): Danau kecil bercahaya.</li>
        </ul>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Simbol dari semua wilayah membentuk "Segel Fragmentasi". Titik
          Singgungan menjadi lokasi aliran sihir bertemu.
        </p>
        <strong>Misi Akhir:</strong>
        <p>
          Guild menghadapi Malapetaka di Titik Singgungan. Harus memperbaiki
          Segel Fragmentasi atau menghentikan kebangkitan penuh.
        </p>
        <strong>Konfrontasi:</strong>
        <p>
          Malapetaka adalah entitas purba, ingin menyatukan aliran sihir secara
          korup. Guild harus menghadapi manifestasinya.
        </p>
        <strong>Pilihan Akhir:</strong>
        <p>
          Memulihkan Astreya sepenuhnya atau menciptakan keseimbangan baru.
        </p>
        ...
        <ul>
          ...
          <li>
            Manifestasi: Kabut Pikiran, Es Pembusuk, Penyakit Akar, Pasang Surut
            Busuk, Lumpur Wabah, Busuk Rimba, Ilusi Pasir, Pusaran Bawah
            Tanah.
          </li>
          <li>
            Resolusi: menetralisir atau menyeimbangkan Malapetaka, meskipun
            Astreya berubah selamanya.
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Malapetaka ternyata alat dari entitas purba bernama{" "}
          <em>"Fragmentor"</em> yang menguji dunia Astreya.
        </p>
        <strong>NPC Terdekat Terlibat:</strong>
        <p>
          Salah satu NPC (Arimantya atau Balam) bisa saja terpengaruh Fragmentor
          atau menjadi pionnya.
        </p>
        <strong>Simbol Menyesatkan:</strong>
        <p>
          Simbol Segel Fragmentasi yang dikumpulkan sebagian adalah{" "}
          <em>salinan palsu</em>. Jika diperbaiki salah, justru memperparah
          Malapetaka.
        </p>
        <strong>Titik Singgungan Palsu:</strong>
        <p>
          Lokasi Titik Singgungan yang didatangi Guild mungkin bukan pusat asli,
          melainkan dimensi paralel ("Dimensi Cermin Astreya").
        </p>
        <strong>Pilihan Moral Sulit:</strong>
        <p>
          Guild harus memilih: mengikuti petunjuk Fragmentor dan menyelamatkan
          sebagian Astreya, atau mencari pusat asli dengan risiko besar.
        </p>
        <strong>GM Tips:</strong>
        <ul>
          <li>Buka plot twist ini bertahap agar suspense terjaga.</li>
          <li>Gunakan NPC yang dipercaya untuk kejutan.</li>
          <li>
            Simbol palsu & Titik Singgungan palsu bisa jadi side quest
            tambahan.
          </li>
        </ul>
      </>
